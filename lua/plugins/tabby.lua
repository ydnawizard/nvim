return{
	...
	config=function()
		local theme = {
			fill = 'TabLineFill',
			head = { fg = '#B31D28', bg = '#1c1e26', style = 'italic' },
			current_tab = { fg = '#1c1e26', bg = '#B31D28', style = 'italic' },
			tab = { fg = '#c5cdd9', bg = '#1c1e26', style = 'italic' },
			win = { fg = '#1c1e26', bg = '#B31D28', style = 'italic' },
			tail = { fg = '#B31D28', bg = '#1c1e26', style = 'italic' },
		}
		require('tabby').setup({
